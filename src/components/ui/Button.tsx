...
export function Button({
  ...
  const variants = {
    primary:
      "bg-[var(--secondary-color)] text-white hover:opacity-90 focus:ring-[var(--secondary-color)]",
    secondary:
      "bg-[var(--primary-color)] text-white hover:opacity-90 focus:ring-[var(--primary-color)]",
    outline:
      "border-2 border-[var(--primary-color)] text-[var(--primary-color)] hover:bg-[var(--primary-color)] hover:text-white",
    ghost: "text-[var(--primary-color)] hover:bg-gray-100",
