...
export function WorkspaceRow({
  ...
  return (
    <>
      <div className="w-full rounded-[28px] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm transition-colors">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button className="flex items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 transition hover:bg-slate-100 dark:hover:bg-slate-700">
            ...
            {(isOwner || workspace.role) && (
              <button
                ...
                className="flex items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 transition hover:bg-slate-100 dark:hover:bg-slate-700"
              >
            ...
            {(isOwner || workspace.permissions?.includes("ws:update") || workspace.permissions?.includes("role:view")) && (
              <>
                ...
                {isOwner && (
                  <button className="flex items-center gap-2 rounded-xl bg-violet-50 dark:bg-violet-900/30 px-4 py-2 text-sm font-medium text-violet-700 dark:text-violet-400 transition hover:bg-violet-100 dark:hover:bg-violet-900/50">
